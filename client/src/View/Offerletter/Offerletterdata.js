...
export default function OfferletterData() {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(
        `http://localhost:4000/api/formRoutes/updateform/${id}`,
        selectedForm
      );
          ...
          <div className="modal-content">
            ...
            <div className="new-div">
              <p className="lettername">
                <span className="text">Dear {viewedForm.name},</span>
              </p>
              <p className="size">
                I am pleased to extend an offer for an internship at Arohi
                Software Development. We were impressed with your qualifications
                and enthusiasm during the interview, and we believe that your
              ...
              <p className="lettername">
                ...
                {formatDate(viewedForm.startdate)}
              </p>
              <p className="lettername">
                <span className="text">End Date: </span>
                {formatDate(viewedForm.enddate)}
              </p>

              {/* Salary details */}
              {viewedForm.range === "Range" ? (
                <p className="lettername">
                  <span className="text">Salary: </span>Between{" "}
                  {viewedForm.start}k to {viewedForm.end}k per month (based on
                  performance and contribution to work)
                </p>
              ) : (
                <p className="lettername">
            ...
            <ul>
              <p className="size">
                {" "}
                1. Web Development: Developing and maintaining web applications,
                websites, and systems using a combination of front-end (HTML,
                CSS, JavaScript) and back-end (e.g., Node.js, Python, Ruby on
                Rails) technologies.
              </p>
              <p className="size">
                {" "}
              ...
              <p className="size">
                6. Version Control: Using version control systems (e.g., Git) to
                manage code repositories and collaborate with team members.
              </p>
              <p className="size">
              ...
              <p className="size">
                8. Testing and Quality Assurance: Performing testing and quality
                assurance to identify and fix bugs and ensure the reliability of
                the software.
              </p>
              <p className="size">
                9. Cross-Platform Compatibility: Ensuring that web applications
                and websites are compatible with various browsers, devices, and
                screen sizes.
              </p>
              <p className="size">
              ...
              <p className="size">
                13. Problem Solving: Identifying and resolving technical issues
                and challenges in a dynamic development environment.
              </p>
              <p className="size">
              ...
              <p className="size">
                15. Continuous Learning: Taking advantage of the internship as a
                learning opportunity, seeking guidance from mentors, and
                expanding your technical skills.
              </p>
            </ul>
            <p className="size">
              We are excited about the prospect of having you join our team and
              look forward to a mutually beneficial partnership.
            </p>
            <p className="size">
              Please review the offer letter and, if you accept, respond via
              WhatsApp.
            </p>
            ...
            <p className="size">
              ...
              our company's policies and procedures throughout your internship.
          ...
          {last && (
            <div className="offerletter2">
              <div className="new-div">
                ...
                <p className="size">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please
                  indicate your acceptance of this offer by signing and
                  returning a copy of this letter by {formattedDate}. If you
